    ...
    <div class="col-md-12 mt-5 position-relative" style="background:#0D0D0D;height:150px">
        <div class="row w-100 position-absolute start-50 top-50 translate-middle d-flex justify-content-center">
            <div class="col-md-4 me-1">
                <button class="btn btn-lg col-md-12 btnearning" id="transfer1">Circuit</button>
            </div>
            <div class="col-md-4 ms-1">
                <button class="btn btn-lg col-md-12 btnearning" id="transfer2">Outside Circuit</button>
            </div>
        </div>
    </div>
</div>
<div id="circuit" class="row mt-3">
    <form id="frmcircuit" action="<?=base_url()?>/member/tobank/confirm" method="post">
        <input type="hidden" name="transfer" value="circuit">
        <input type="hidden" name="currency" value="<?=$currency["currency"]?>">
        <?php if ($currency["currency"]=="USD"){?>
        ...
        <div class="col-md-11">
            <input type="text" class="form-control" id="name" name="name" placeholder="Recipient Name" maxlength="50" required>
        </div>
        <div class="col-md-11 mt-1">
            Routing Number
        </div>
        <div class="col-md-11">
            <input type="text" class="form-control" id="bic" name="bic" placeholder="Routing Number" maxlength="15" required>
        </div>        
        <div class="col-md-11 mt-1">
            Account Number
        </div>
        <div class="col-md-11">
            <input type="text" class="form-control" id="iban" name="iban" placeholder="Account Number" maxlength="50" required>
        </div>        
        <div class="col-md-11 mt-1">
            Account Type
        </div>
        ...
        <div class="col-md-11">
            <input type="text" class="form-control" id="causal" name="causal" placeholder="Causal" maxlength="50" required>
        </div>
        <div class="col-md-11 mt-1">
            Amount
        </div>
        <div class="col-md-11">
            <input type="text" class="form-control" id="amountus" name="amount" placeholder="Amount" maxlength="15" required>
        </div>        
        <div class="col-md-11 mt-1">
            Recipient Address
        </div>
        <div class="col-md-11">
            <input type="text" class="form-control" id="address" name="address" placeholder="Recipient Address" maxlength="50">
        </div>
        <div class="col-md-11 mt-1">
            City
        </div>
        ...
        <div class="col-md-11">
            <input type="text" class="form-control" id="postalcode" name="postalcode" placeholder="Postal Code" maxlength="50">
        </div>    
        <div class="col-md-12 mt-2 text-end">
            <button type="button" id="sendcircuit" class="btn btn-lg col-md-4 btnearning">Send</button>
        </div>
    </form>
</div>
<div id="outside" class="row mt-3">
    <form id="frmoutside" action="<?=base_url()?>/member/tobank/confirm" method="post">
        <input type="hidden" name="transfer" value="outside">
        <input type="hidden" name="currency" value="<?=$currency["currency"]?>">
        <input type="hidden" id="token" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">            
        <div class="col-md-11">
            Recipient Name
        ...
        <div class="col-md-11">
            <input type="text" class="form-control" id="amountusinter" name="amount" placeholder="Amount" maxlength="15" required>
        </div>        
        <div class="col-md-11 mt-1">
            Recipient Address
        </div>
        ...
        <div class="col-md-12 mt-2 text-end">
            <button type="button" id="sendoutside" class="btn btn-lg col-md-4 btnearning">Send</button>
        </div>
    </form>
</div>
        ...
        <div class="modal-content removecolor" style="border:none">
            <div class="modal-body">
                <div class="row" style="background:#363636;border-radius:30px">
                    <div class="col-md-12 p-2 roundedbar">
                        <span class="ms-2">Transfer Wallet to Bank</span>
                    </div>
                    <form id="frmwltconfirm" action="<?=base_url()?>member/towallet/process" method="post">
                        <div class="col-md-12 textgreen m-2">
                            <input type="hidden" id="circuitamount" name="amount">
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    Amount
                                </div>
                                <div class="col-md-6">
                                    <?=$_SESSION["walletbank"]["amount"]?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <?=$_SESSION["walletbank"]["newbalance"]?>
                                </div>
                            </div>
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="col-md-6">
                                    <?=$_SESSION["walletbank"]["iban"]?>
                                </div>
                            </div>
                            <div class="row mt-1">
                                <div class="col-md-6">
                                    <?php
                                        if (($_SESSION["walletbank"]["currency"]=="USD") && ($_SESSION["walletbank"]["transfer"]=="circuit")){
                                            echo "Routing Number";
                                        }else{
                                            echo "SWIFT";
                                        }
                                ...
                                <div class="col-md-6">
                                    <?=$_SESSION["walletbank"]["bic"]?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 roundedbar text-center">
