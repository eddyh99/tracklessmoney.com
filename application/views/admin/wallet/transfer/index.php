...
<div class="card mt-2 removecolor" style="border:1px solid white">
    ...
    <div class="col-sm-12 mt-5">
        <table id="wallettransfer" class="display nowrap table-hover" width="100%">
            <thead>
                <tr>
                    <th class="gridcolor">Sender</th>
                    <th class="gridcolor">Receiver</th>
                    <th class="gridcolor">Amount</th>
                    <th class="gridcolor">Referral Sender</th>
                    <th class="gridcolor">Referral Receiver</th>
