...
var table=$('#wallettransfer').DataTable({
            "scrollX": true,
            "responsive": true,
            "pageLength": 50,
            "ajax": {
                "url": "<?=base_url()?>admin/wallet/historywallet",
                "type": "POST",
                "data": {
        	...
        	"aoColumnDefs": [{
        		...
        		"mRender": function (data, type, full, meta){
        		    var button='<a href="<?=base_url()?>admin/wallet/transferdetail/'+full.id+'" class="btn btn-secondary btn-sm">Detail</a>&nbsp;<a href="<?=base_url()?>admin/wallet/deletewallet/'+full.id+'" class="btn btn-danger btn-sm">Delete</a>';
        			return button;
        		}
        	}],
            "columns": [
                ...
                { "data": "referral_sender","className": "dt-body-right", "render":$.fn.dataTable.render.number( ',', '.', 2, '' ) },
                { "data": "referral_receiver","className": "dt-body-right", "render":$.fn.dataTable.render.number( ',', '.', 2, '' ) },
